...
(function() {
    [].slice.call(document.querySelectorAll('.adam-trigger')).forEach(function(el) {
        el.addEventListener('click', function() {
            ...
            adamodal.open({
                ...
                style: 'width: 640px;',
                onok: function() {
                    adamodal.alert('OK button pressed');
                    return false;
                }
            });
        });
        ...
        el.addEventListener('click', function() {
            adamodal.open({
                ...
                buttons: {
                    ...
                    run: '<button class="adam-button demo-button-run" style="background: #f44336;">run</button>',
                    cancel: 'cancel'
                },
    ...
    function adamodalDemo1() {
        adamodal.open({
            title: '<div id="demo1-form">\
            ...
            onok: function() {
                ...
                adamodal.alert('Welcome, ' + uname);
            }
        });
    }

    function adamodalDemo2() {
        adamodal.startSpin();
        ...
        adamodal.open({
            ...
            effect: '3d_rotate_bottom',
            aftercreate: function(param) {
                param.element.querySelector('.adam-content .adam-body').style.padding = '0';
    ...
    function adamodalDemo4() {
        adamodal.open({
            ...
            beforeshow: function(param) {
                [].slice.call(param.element.querySelectorAll('.adam-body *')).forEach(function(el) {
                    let border = false;
    ...
    function adamodalDemo5() {
        window.open('demo5.html');
    }

    function adamodalDemo6() {
        adamodal.open({
            title: 'inline',
            body: {
                src: '#demo6-content'
